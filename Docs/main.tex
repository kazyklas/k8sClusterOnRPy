...
V práci byly rozebrány a vysvětleny všechny potřebné pojmy tak, aby čtenář byl schopen pochopit jak fungují technologie použité k sestavení klastru. Klastr byl nasazen a spuštěn s danými útoky. Klastr je popsán a jejasně znázorněno jak byl sestaven a spravován. Výsledky lámání hesel jsou analyzovány a okomentovány. Na přiloženém médiu jsou zdrojové kódy potřebné pro lokální replikaci a otestování. 
